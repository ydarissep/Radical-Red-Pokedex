    ...
    for (let i = 0; i < locationsArray.length; i++){
        ...
        for(let j = 0; j < methodArray.length; j++){
            ...
            for(let k = 0; k < speciesArray.length; k++){
                ...
                if(speciesArray[k] === "SPECIES_NONE"){
                    continue
                }
...
function createRow(location, method){
    ...
    spriteHeader.src = `https://raw.githubusercontent.com/ydarissep/inflamed-red-pokedex/main/src/locations/${method.replaceAll(" ", "_")}.png`
