...
const u16 gEggMoves[] =
{
	...
	egg_moves(TAUROS_P_WATER,
		MOVE_CURSE,
		MOVE_ENDEAVOR),
	egg_moves(TAUROS_P_FIRE,
		MOVE_CURSE,
		MOVE_ENDEAVOR),
...
u8 GetEggMoves(void* pokemon, u16 *eggMoves)
{
	...
	for (i = 0; i < ARRAY_COUNT(gEggMoves) - 1; ++i) //made change here 
	{
